...
class AuthenticationController {
    ...
    hasDigi3CaptureAccess(permissions) {
        return (0, util_1.verifyPermission)(false, permissions, DIGI3_CAPTURE_ACCESS_PERMISSION_ID);
    }
    async login(ctx) {
        ...
        const user = await User_1.default
            ...
            query.select('id', 'name', 'shortname', 'foldername', 'cloud', 'responsablename', 'status', 'use_device_control', 'use_device_cookie_control', 'module_order_certificates');
        })
    ...
    async verifyDigi3CaptureAccess({ auth, response }) {
