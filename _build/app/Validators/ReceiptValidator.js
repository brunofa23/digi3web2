...
class ReceiptValidator {
    constructor(ctx) {
        ...
        this.schema = Validator_1.schema.create({
            ...
            deliveryName: Validator_1.schema.string.optional({ trim: true }, [Validator_1.rules.maxLength(100)]),
            deliveryCpf: Validator_1.schema.string.optional({ trim: true }, [Validator_1.rules.maxLength(11)]),
            deliveryDate: Validator_1.schema.date.optional(),
            trackingCod: Validator_1.schema.string.optional({ trim: true }, [Validator_1.rules.maxLength(50)]),
