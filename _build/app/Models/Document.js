...
const OrderCertificate_1 = __importDefault(require("./OrderCertificate"));
...
__decorate([
    (0, Orm_1.belongsTo)(() => OrderCertificate_1.default, {
        foreignKey: 'order_certificate_id',
    }),
    __metadata("design:type", Object)
], Document.prototype, "orderCertificate", void 0);
__decorate([
...
__decorate([
    (0, Orm_1.column)(),
    __metadata("design:type", Object)
], Document.prototype, "order_certificate_id", void 0);
__decorate([
    (0, Orm_1.column)(),
    __metadata("design:type", Number)
