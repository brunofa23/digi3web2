...
Route_1.default.group(() => {
    ...
    Route_1.default.post('/typebooks/:typebooks_id/fullreprocessing', 'BookrecordsController.fullReprocessing');
    ...
    Route_1.default.post("/imagesforitem", 'BookrecordsController.imagesForItem');
