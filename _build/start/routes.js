...
Route_1.default.group(() => {
    ...
    Route_1.default.get('/sales-stages', 'SalesOpportunitiesController.stages').middleware('crm_permission');
    Route_1.default.get('/sales-opportunities/users', 'SalesOpportunitiesController.users').middleware('crm_permission');
    Route_1.default.patch('/sales-stages/:id/active', 'SalesOpportunitiesController.updateStage').middleware('crm_permission');
    Route_1.default.get('/sales-opportunities/funnel', 'SalesOpportunitiesController.funnel').middleware('crm_permission');
    Route_1.default.get('/sales-opportunities/follow-ups', 'SalesOpportunitiesController.followUps').middleware('crm_permission');
    Route_1.default.get('/sales-opportunities', 'SalesOpportunitiesController.index').middleware('crm_permission');
    Route_1.default.get('/sales-opportunities/:id', 'SalesOpportunitiesController.show').middleware('crm_permission');
    Route_1.default.get('/sales-opportunities/:id/activities', 'SalesOpportunitiesController.activities').middleware('crm_permission');
    Route_1.default.post('/sales-opportunities/:id/activities', 'SalesOpportunitiesController.storeActivity').middleware('crm_permission');
    Route_1.default.post('/sales-opportunities', 'SalesOpportunitiesController.store').middleware('crm_permission');
    Route_1.default.patch('/sales-opportunities/:id', 'SalesOpportunitiesController.update').middleware('crm_permission');
    Route_1.default.delete('/sales-opportunities/:id', 'SalesOpportunitiesController.destroy').middleware('crm_permission');
    ...
    Route_1.default.post("/tokentoimages/access-status", "TokenToImagesController.accessStatus");
